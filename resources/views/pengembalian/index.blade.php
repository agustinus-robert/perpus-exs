@extends('layout')
     ...
     <div class='row p-4'>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mx-auto">
                    <li class="nav-item active">
                      <a class="nav-link" href="#">Laporan Pengembalian</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="jumbotron mt-5">
          <h1 class="display-4">Modul Pengembalian Buku</h1>
          <p class="lead">Pengembalian buku dapat dilakukan melalui 2 link di atas</p>
          <hr class="my-4">
